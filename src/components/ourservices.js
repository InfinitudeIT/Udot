...
import customerFocus from "../assets/delivery.avif"; // Update the path if needed
import domesticDelivery from "../assets/delivery.avif"; // You'll need to add this image
import internationalDelivery from "../assets/cargoloading.avif"; // You'll need to add this image
